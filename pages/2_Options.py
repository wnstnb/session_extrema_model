...
st.title('CBOE Options Data')
st.markdown('Forked from [CBOEDashboard](https://github.com/deeleeramone/CBOEDashboard).')

col_1,col_2,col_3,col_7,col_8,col_9,col_10 = st.columns([0.20,0.33,0.20,0.20,0.20,0.20,1])
with col_1:
